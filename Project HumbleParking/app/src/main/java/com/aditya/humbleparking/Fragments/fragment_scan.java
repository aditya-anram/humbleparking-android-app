...
public class fragment_scan extends Fragment implements ZBarScannerView.ResultHandler, MessageDialogFragment.MessageDialogListener{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.activity_fragment_scan, container, false);
